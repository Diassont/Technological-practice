  ...
  <div class="container">
    ...
    <div class="product-grid" id="products" style="margin-top:14px;">
      ...
      <article class="p-card"
        data-title="ASUS TUF A15 RTX 4060"
        data-price="38999"
        data-brand="asus"
        data-ram="16"
        data-screen="15">
      ...
      <!-- CARD 2 -->
      <article class="p-card"
        data-title="Lenovo LOQ 15 i5 RTX 4050"
        data-price="32999"
        data-brand="lenovo"
        data-ram="16"
        data-screen="15">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-2.jpg'); ?>"
            alt="Lenovo LOQ 15"
            loading="lazy">
        </div>
        ...
        <div class="p-body">
          ...
          <div class="p-bottom">
            ...
            <button class="btn btn-outline p-more"
              ...
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-2.jpg'); ?>"
      ...
      <!-- CARD 3 -->
      <article class="p-card"
        data-title="HP Pavilion 14 i5 16GB"
        data-price="26999"
        data-brand="hp"
        data-ram="16"
        data-screen="14">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-3.jpg'); ?>"
            alt="HP Pavilion 14"
            loading="lazy">
        </div>
        ...
        <div class="p-body">
          ...
          <div class="p-bottom">
            ...
            <button class="btn btn-outline p-more"
              ...
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-3.jpg'); ?>"
      ...
      <!-- CARD 4 -->
      <article class="p-card"
        data-title="Acer Aspire 5 Ryzen 8GB"
        data-price="19999"
        data-brand="acer"
        data-ram="8"
        data-screen="15">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-4.jpg'); ?>"
            alt="Acer Aspire 5"
            loading="lazy">
        </div>

        <div class="p-body">
          <h3 class="p-title">Acer Aspire 5</h3>
          <p class="p-desc">Ryzen • 8GB • 512GB • бюджетний</p>
          ...
          <div class="p-bottom">
            <div class="p-price">
              <div class="price">19 999 грн</div>
              <div class="muted">в наявності</div>
            </div>

            <button class="btn btn-outline p-more"
              data-title="Acer Aspire 5"
              data-price="19 999 грн"
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-4.jpg'); ?>"
              data-desc="Бюджетний ноутбук для документів, браузера та навчання."
              data-specs="Екран: 15.6&quot;|CPU: Ryzen|RAM: 8GB|SSD: 512GB|Графіка: інтегрована"
            >Детальніше</button>
          </div>
        </div>
      </article>
      ...
      <!-- CARD 5 -->
      <article class="p-card"
        data-title="ASUS Zenbook 14 OLED 16GB"
        data-price="41999"
        data-brand="asus"
        data-ram="16"
        data-screen="14">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-5.jpg'); ?>"
        ...
        <div class="p-body">
          ...
          <div class="p-bottom">
            ...
            <button class="btn btn-outline p-more"
              ...
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-5.jpg'); ?>"
      ...
      <!-- CARD 6 -->
      <article class="p-card"
        data-title="Lenovo ThinkPad 14 8GB"
        data-price="23999"
        data-brand="lenovo"
        data-ram="8"
        data-screen="14">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-6.jpg'); ?>"
        ...
        <div class="p-body">
          ...
          <div class="p-bottom">
            ...
            <button class="btn btn-outline p-more"
              ...
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-6.jpg'); ?>"
      ...
      <!-- CARD 7 -->
      <article class="p-card"
        data-title="HP Victus 16 RTX 4060 16GB"
        data-price="44999"
        data-brand="hp"
        data-ram="16"
        data-screen="16">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-7.jpg'); ?>"
            alt="HP Victus 16"
            loading="lazy">
        </div>
        ...
        <div class="p-body">
          ...
          <div class="p-bottom">
            ...
            <button class="btn btn-outline p-more"
              ...
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-7.jpg'); ?>"
      ...
      <!-- CARD 8 -->
      <article class="p-card"
        data-title="Acer Swift 3 13 16GB"
        data-price="28999"
        data-brand="acer"
        data-ram="16"
        data-screen="13">
        <div class="p-imgwrap">
          <img class="p-img"
            src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-8.jpg'); ?>"
            alt="Acer Swift 3"
            loading="lazy">
        </div>

        <div class="p-body">
          <h3 class="p-title">Acer Swift 3</h3>
          <p class="p-desc">Легкий • 16GB • 512GB • компактний</p>
          ...
          <div class="p-bottom">
            <div class="p-price">
              <div class="price">28 999 грн</div>
              <div class="muted">в наявності</div>
            </div>

            <button class="btn btn-outline p-more"
              data-title="Acer Swift 3"
              data-price="28 999 грн"
              data-stock="В наявності • відправка 1–2 дні"
              data-img="<?php echo esc_url(get_template_directory_uri() . '/assets/img/demo-laptop-8.jpg'); ?>"
              data-desc="Легкий ноутбук для навчання/дороги: тонкий корпус і хороша автономність."
              data-specs="Екран: 13&quot;|RAM: 16GB|SSD: 512GB|Вага: легкий|Клас: Ultrabook"
            >Детальніше</button>
          </div>
        </div>
      </article>
